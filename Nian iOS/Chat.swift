...
class ChatViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    func urlString()->String{
        ...
        return "http://nian.so/api/chat.php?page=\(page)&uid=\(safeuid)&shell=\(safeshell)"
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCellWithIdentifier(identifier, forIndexPath: indexPath) as? ChatCell
    ...
    func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat
    {
        var index = indexPath.row
        var data = self.dataArray[index] as NSDictionary
        return  ChatCell.cellHeightByData(data)
    }
