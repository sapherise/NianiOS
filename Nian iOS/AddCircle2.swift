...
//import UIKit
//
//protocol editCircleDelegate2 {
//    func editCircle(editPrivate:Int, editTitle:String, editDes:String, editImage:String)
//}
//
//class AddCircleController2: UIViewController, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate, CircleTagDelegate, UITextViewDelegate {
//    
